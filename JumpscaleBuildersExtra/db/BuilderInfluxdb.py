...
class BuilderInfluxdb(BuilderGolangTools):
    ...
    def install(self):
        ...
        self._copy("{DIR_BASE}/go_proj/bin/influx", "{DIR_BIN}")
        self._copy("{DIR_BASE}/go_proj/bin/influxd", "{DIR_BIN}")
    ...
    def clean(self):
        code_dir = self._joinpaths(self.DIR_BUILD, "github")
    ...
    def startup_cmds(self):
        cmds = j.servers.startupcmd.get(name=self._name, cmd_start=self._name)
        return [cmds]
